...
#define BERKELEY_DB_VERSION 5.1
...
/* Define to 1 if you have the <netax25/axconfig.h> header file. */
/* #undef HAVE_NETAX25_AXCONFIG_H */

/* Define to 1 if you have the <netax25/axlib.h> header file. */
/* #undef HAVE_NETAX25_AXLIB_H */
