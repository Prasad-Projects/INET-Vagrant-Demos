...
ETH_MY_MAC = 0x40,0x40,0x40,0x40,0x40,0x39 #mac 40:40:40:40:40:39 #client mac address
ETH_SMP_TYPE = 0x88b5
ETH_SDS_TYPE = 0x88b6
ETH_SDS = 0x40,0x40,0x40,0x40 ,0x40,0x40 #lan sds mac address
ETH_SDS_NORM = "40:40:40:40:40:40"
SPORT = 62003 #port of this host

ETH_REMOTE_MAC = 0x40, 0x40, 0x40, 0x40, 0x40, 0x41
ETH_REMOTE_MAC1 = "40:40:40:40:40:41"
    ...
    if (tab_smp.has_key(smpfd)) and (len(buf) == bytes1):
        ...
        if res != '0':
           ...
           if ttl > 0:
               ...
               p.setfilter("ether src 40:40:40:40:40:40")
